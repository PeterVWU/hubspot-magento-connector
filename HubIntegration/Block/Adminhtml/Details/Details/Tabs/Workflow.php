...
class Workflow extends \Magento\Backend\Block\Template implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    /**
    ...
    public $_template = 'Makewebbetter_HubIntegration::details/tab/workflow.phtml';
    ...
    {
        return $this->properties->getWorkFlowNames();
    }
    ...
    {
        return $this->properties->getAllWorkFlows($name);
    }
