...
class Index extends \Magento\Backend\App\Action
{
   ...
   /**
    ...
    public $redirectUrlCustomer = 'customer/index';
    public $redirectUrlProduct = 'catalog/product/index';
    ...
    public function execute(){
       try {
            ...
            if (isset($params['export'])) {
                $exportType = $params['export'];
            } if (isset($params['id'])) {
                $id[] = $params['id'];
            }

            if ($this->dataSync->massExportToHubSpot($exportType, $id)) {
               $this->messageManager->addSuccessMessage(__("The ". strtolower($exportType) ." have been exported to HubSpot."));
            }else {
        ...
        if($exportType == 'CONTACT'){
            return $resultRedirect->setPath($this->redirectUrlCustomer);
        }
        if($exportType == 'PRODUCT'){
            return $resultRedirect->setPath($this->redirectUrlProduct);
        }
    }
}
