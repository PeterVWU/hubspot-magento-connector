...
class Quoteexport extends \Magento\Backend\App\Action
{
   ...
   /**
    ...
    public $redirectUrlQuote = 'hubintegration/activeCarts/index';
    ...
    public function execute(){
       try {
            ...
            if ($this->dataSync->massExportToHubSpot("QUOTE",$id)) {
               $this->messageManager->addSuccessMessage(__("The Abandoned Cart have been exported to HubSpot."));
            }else {
        ...
        $resultRedirect = $this->resultFactory->create(ResultFactory::TYPE_REDIRECT);
        return $resultRedirect->setPath($this->redirectUrlQuote);
    }
}
