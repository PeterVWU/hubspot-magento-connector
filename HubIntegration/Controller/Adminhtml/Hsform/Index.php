 ...
 */
namespace Makewebbetter\HubIntegration\Controller\Adminhtml\Hsform;
   ...
   /**
    ...
    public function execute(){
       try {
            ...
            if ($this->connectionManager->senddetailshs(json_encode(['fields' => $data]))) {
               $this->messageManager->addSuccessMessage(__("Thank you for subscribing to us."));
               $this->connectionManager->setHubConfig('formsubscription_status',1);
            }else {
                $this->messageManager->addErrorMessage(__("The please try after some time"));
            }
        } catch (\Exception $e) {
