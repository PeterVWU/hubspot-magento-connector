...
class Customer extends \Magento\Backend\App\Action
{
     ...
     */
    const ADMIN_RESOURCE = 'Makewebbetter_HubIntegration::customer_export_to_hubspot';
    ...
    public function execute()
    {
        try {
            ...
            if($this->dataSync->massExportToHubSpot('CONTACT', $collection->getAllIds())){
                $this->messageManager->addSuccessMessage(__("%1 Customer(s) have been exported to HubSpot.", $collection->getSize()));
