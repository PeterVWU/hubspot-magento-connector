...
class Order extends \Magento\Backend\App\Action
{
     ...
     */
    const ADMIN_RESOURCE = 'Makewebbetter_HubIntegration::order_export_to_hubspot';
    ...
    public function execute()
    {
        try {
            ...
            if($this->dataSync->massExportToHubSpot('DEAL', $collection->getAllIds())){
                $this->messageManager->addSuccessMessage(__("%1 Order(s) have been exported to HubSpot.", $collection->getSize()));
            }else{
