...
class Product extends \Magento\Backend\App\Action
{
     ...
     */
    const ADMIN_RESOURCE = 'Makewebbetter_HubIntegration::product_export_to_hubspot';

    /**
     * @var string
     */
    protected $redirectUrl = 'catalog/product/index';
    ...
    public function execute()
    {
        try {
            ...
            if($this->dataSync->massExportToHubSpot('PRODUCT', $collection->getAllIds())){
                $this->messageManager->addSuccessMessage(__("%1 Product(s) have been exported to HubSpot.", $collection->getSize()));
            }else{
