...
class Olddataexportauth extends \Magento\Framework\App\Action\Action
{
    const CHUNK_SIZE = 50;
    ...
    public function execute()
    {
        ...
        if ($request && empty($getQueuedItems)) {
            return $this->resultRedirectFactory->create()->setPath('hubintegration/config/olddataexportauth');
        }
        $resultPage = $this->resultPageFactory->create();
        $resultPage->getConfig()->getTitle()->set('HubSpot Magento Export Old Data');
        return $resultPage;
    }
}
